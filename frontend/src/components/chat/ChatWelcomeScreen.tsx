  ...
  return (
    <SidebarInset className="flex w-full h-full bg-transparent">
      ...
      <div className="flex bg-primary-foreground rounded-2xl flex-1 items-center justify-center">
        ...
        <h2 className="text-2xl font-bold mb-2 bg-gradient-chat bg-clip-text text-transparent"> Welcome to Talkify, let's get started!!!</h2>
        <p className="text-muted-foreground">Please select one conversation to begin chatting</p>
        </div>
      </div>
    </SidebarInset>
  )
